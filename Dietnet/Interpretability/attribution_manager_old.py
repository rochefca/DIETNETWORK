...
class AttributionManager():
    ...
    def initialize_attribution_method(self, attr_type=None, backend=None, **kwargs):
        ...
        if attr_type == 'int_grad' and not self.no_attribution_mode:
            ...
            print('No attribution type selected!')
            self.no_attribution_mode = True
        else:
            raise NotImplementedError
        
        if self.no_attribution_mode:
            print('AttributionManager object in no_attribution_mode. You can use this object to analyze loaded attributions, but cannot make attribution files!')
    ...
    def make_attribution_files(self, 
        ...
        if self.no_attribution_mode:
            print('Cannot perform this action in no_attribution_mode')
        else:
    ...
    def _load_attribution_file(self, attributions_path):
    ...
    def _close_attribution_file(self):
        self.hf.close()
    ...
    def check_completeness(self, indices, baseline, x_test_normed, attributions_path):
        ...
        if self.no_attribution_mode:
            ...
            self._load_attribution_file(attributions_path)
